...
help:
	@echo "Vass Organic — available commands:"
	@echo ""
...
up:
	docker compose up -d
	@echo "✓ Vass Organic is starting. Run 'make logs' to follow."
...
backup:
	@mkdir -p backups
	@FILENAME="backups/vass-organic-$$(date +%Y%m%d-%H%M%S).sql.gz"; \
