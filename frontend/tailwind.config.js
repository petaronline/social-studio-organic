  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        // Handwriting, for moodboard notes. Casual Human, self-hosted via
        // next/font/local (CSP blocks external font hosts). System cursive
        // stack as the fallback while the face loads / if it's missing.
        hand: ['var(--font-casual-human)', '"Bradley Hand"', '"Segoe Print"', 'ui-rounded', 'cursive'],
      },
